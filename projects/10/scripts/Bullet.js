class Bullet {
    ...
    constructor(x, y, direction) {
        ...
        this._image = null;
        if (this.direction.x > 0) { this._image = IMAGES.bulletRight; }
        if (this.direction.x < 0) { this._image = IMAGES.bulletLeft; }
        if (this.direction.y > 0) { this._image = IMAGES.bulletDown; }
        if (this.direction.y < 0) { this._image = IMAGES.bulletUp; }
    }
