/**
 * Creates Terrain objcet
 * @constructor
 * @param {Number} terrainSize
 * @param {Number} terrainHeight
 * @param {String} terrainColor
 * @param {THREE.Vector3} terrainPosition
 * @param {Array} dataArray
 */
function Terrain(terrainSize, terrainHeight, terrainColor, terrainPosition, dataArray) {
    ...
    */
    var terrainGeometry = new THREE.PlaneBufferGeometry(terrainSize, terrainSize, worldWidth - 1, worldDepth - 1);
    ...
    */
    ...
    let data = null;
    if (dataArray) { data = dataArray; }
    else { data = generateHeight(worldWidth, worldDepth); }
    this.getData = function () { return data; } // getter do danych liczbowych
    ...
    */
    ...
    mesh.position.set(terrainPosition.x, terrainPosition.y, terrainPosition.z)
