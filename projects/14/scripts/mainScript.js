...
function draw(ctx) {
    ...
    //Player movements
    if (KEYPRESSED["A"]) { PLAYER.move.left = true; } else { PLAYER.move.left = false; }
    if (KEYPRESSED["D"]) { PLAYER.move.right = true; } else { PLAYER.move.right = false; }
